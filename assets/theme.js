...
theme.Header = (function() {
  ...
  function cacheSelectors() {
    cache = {
      ...
      // Added by Justin L on October 16 2019 Theme Specialist
  ...
  function collapseMenu() {
    ...
    // Added by Justin L on October 16 2019 Theme Specialistd
    cache.$siteHeaderWrapper.removeClass('site-header__margin');
    cache.$siteHeader
  ...
  function expandMenu() {
    ...
    // Added by Justin L on October 16 2019 Theme Specialistd
    cache.$siteHeaderWrapper.addClass('site-header__margin');
    cache.$siteHeader
